...
sim_y = predict(med_prior,summary=TRUE)

df_prior = df

df_prior$PF= sim_y[,1,"PF"]

df_prior$J1= sim_y[,1,"J1"]

df_prior$J2= sim_y[,1,"J2"]

df_prior$J3= sim_y[,1,"J3"]

df_prior$J4= sim_y[,1,"J4"]

df_prior$dPO= sim_y[,1,"dPO"]
